...
async function exploreAPI() {
  ...
  console.log('-'.repeat(80));
  const devices = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices`);
  ...
  if (devices.ok && devices.data?.data) {
    ...
    console.log('Sample device structure:', JSON.stringify(devices.data.data[0], null, 2));
  } else {
  ...
  if (devices.ok && devices.data?.data?.length > 0) {
    ...
    console.log(`Using device "${devices.data.data[0].name}" (${sampleDeviceId}) for exploration`);
    console.log();
  }
  ...
  if (sampleDeviceId) {
    ...
    console.log('-'.repeat(80));
    const deviceDetails = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}`);
    ...
    console.log('-'.repeat(80));
    const telemetry = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/data`);
    ...
    console.log('-'.repeat(80));
    const stream = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/stream`);
    ...
    console.log('-'.repeat(80));
    const state = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/state`);
    ...
    console.log('-'.repeat(80));
    const settings = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/settings`);
    ...
    console.log('-'.repeat(80));
    const logs = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/logs`);
    ...
    console.log('-'.repeat(80));
    const events = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/events`);
    ...
    console.log('-'.repeat(80));
    const tags = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/tags`);
    ...
    console.log('-'.repeat(80));
    const certs = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/certificates`);
    ...
    console.log('-'.repeat(80));
    const firmware = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/devices/${sampleDeviceId}/firmware`);
  ...
  console.log('-'.repeat(80));
  const blueprints = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/blueprints`);
  ...
  console.log('-'.repeat(80));
  const projectTags = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/tags`);
  ...
  console.log('-'.repeat(80));
  const pipelines = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/pipelines`);
  ...
  console.log('-'.repeat(80));
  const artifacts = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/artifacts`);
  ...
  console.log('-'.repeat(80));
  const apiKeys = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/api-keys`);
  ...
  console.log('-'.repeat(80));
  const webhooks = await goliothRequest(`/projects/${GOLIOTH_PROJECT_ID}/webhooks`);
  ...
  console.log('- Total Devices:', devices.ok ? devices.data?.data?.length : 'Unknown');
  console.log();
}
