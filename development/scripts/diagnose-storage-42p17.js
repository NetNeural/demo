...
if (!SERVICE_KEY) {
  console.error('❌ Missing STAGE_SUPABASE_SERVICE_ROLE_KEY environment variable');
  process.exit(1);
}
...
async function diagnose() {
  ...
  if (uploadError) {
    ...
    if (uploadError.message.includes('42P17')) {
      ...
      console.log('   This means the storage.objects table or bucket reference is broken');
      console.log('\n🔧 FIXES TO TRY:');
