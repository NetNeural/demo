...
async function backfillUsers() {
  ...
  try {
    ...
    const missingUsers = authUsers.filter(authUser => !publicUserIds.has(authUser.id));
    ...
    console.log(`⚠️  Found ${missingUsers.length} auth users without public.users records:\n`);
