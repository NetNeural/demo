...
async function diagnose() {
  ...
  try {
    ...
    if (profileError || !userProfile) {
      ...
      console.log('   Organization ID:', userProfile.organization_id || 'NULL ❌')
      ...
      if (userProfile.organization_id) {
        ...
        if (orgError || !org) {
          console.log('❌ Organization does NOT exist:', userProfile.organization_id)
    ...
    if (issues.length === 0) {
      ...
      console.log('\n🔧 Auto-fix available!')
      console.log('Run this script with --fix flag to automatically fix these issues:')
