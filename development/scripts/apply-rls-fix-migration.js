...
async function applyMigration() {
  ...
  // Read migration file
  const migrationPath = path.join(__dirname, '../supabase/migrations/20260214000001_fix_organization_members_view_policy.sql');
  ...
  if (countError) {
    ...
    console.log(`✅ Can now count ${count} members in NetNeural Demo organization`);
  }
}
