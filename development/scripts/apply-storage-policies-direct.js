...
async function applyPolicies() {
  ...
  for (const policy of policies) {
    ...
    try {
      ...
      if (error) {
        ...
        const response = await fetch('https://atgbmxicqikmapfqouco.supabase.co/rest/v1/rpc/exec_sql', {
          method: 'POST',
          headers: {
  ...
  console.log('If automated application failed, please manually apply the policies:');
  console.log('1. Go to: https://supabase.com/dashboard/project/atgbmxicqikmapfqouco/sql/new');
  console.log('2. Copy the SQL from: development/supabase/migrations/20260216000001_apply_storage_policies.sql');
