...
**Notification/Communication Platforms:** 6. ⏳ **SMTP** - Email notifications (NOT APPLICABLE - different domain) 7. ⏳ **Slack** - Slack notifications (NOT APPLICABLE - different domain) 8. ⏳ **Webhook** - Generic webhooks (NOT APPLICABLE - different domain)
    ...
    await supabase
      ...
      .update({
        ...
        settings: {
          ...
          migration_notice:
            'Google IoT Core discontinued. Please migrate to AWS IoT or Azure IoT.',
        },
      })
