...
// Configuration
const SUPABASE_URL = process.env.SUPABASE_URL || 'https://atgbmxicqikmapfqouco.supabase.co';
...
console.log(`📡 Polling Supabase every ${POLL_INTERVAL / 1000}s for restart requests`);
