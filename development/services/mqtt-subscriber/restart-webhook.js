...
const RESTART_TOKEN = process.env.RESTART_TOKEN || crypto.randomBytes(32).toString('hex');
...
server.listen(PORT, () => {
  ...
  console.log(`   POST /restart - Restart service (requires X-Restart-Token header)`);
  console.log('');
});
