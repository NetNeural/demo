      ...
      <nav className="nav">
        <div className="nav-container">
          <div className="nav-links">
            ...
            <Link href="/overview" className="nav-link active">Overview</Link>
          </div>
          <div className="text-small">Platform Overview</div>
        </div>
      </nav>
      ...
      <section className="section section-lg">
        <div className="container text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <Link href="/mvp" className="btn btn-primary btn-lg">
              <div className="icon-container icon-sm mr-2">
                <SimpleIcons.PlayIcon />
              </div>
              View Live Dashboard
            </Link>
          </div>
      ...
      <section className="section bg-gradient">
        <div className="container text-center">
          <div className="max-w-2xl mx-auto">
            ...
            <Link href="/mvp" className="btn btn-light btn-lg">
              <div className="icon-container icon-sm mr-2">
                <SimpleIcons.RocketLaunchIcon />
              </div>
              Launch Dashboard
            </Link>
          </div>
