...
export const DEVICE_CLASSES = [
  { value: 'temperature', label: 'Temperature', suggestedUnits: ['°C', '°F', 'K'] },
  { value: 'humidity', label: 'Humidity', suggestedUnits: ['%', '% RH'] },
  { value: 'pressure', label: 'Pressure', suggestedUnits: ['hPa', 'mbar', 'Pa', 'psi', 'atm'] },
  { value: 'illuminance', label: 'Illuminance / Light', suggestedUnits: ['lux', 'lm', 'fc'] },
  ...
  { value: 'air_quality', label: 'Air Quality', suggestedUnits: ['ppm', 'ppb', 'mg/m³', 'µg/m³'] },
  { value: 'flow', label: 'Flow', suggestedUnits: ['L/min', 'gal/min', 'm³/h'] },
  { value: 'level', label: 'Level', suggestedUnits: ['%', 'cm', 'm', 'mm'] },
  { value: 'speed', label: 'Speed', suggestedUnits: ['m/s', 'km/h', 'mph', 'knots'] },
  { value: 'weight', label: 'Weight', suggestedUnits: ['kg', 'g', 'lb', 'oz'] },
  { value: 'distance', label: 'Distance', suggestedUnits: ['m', 'cm', 'mm', 'km', 'ft', 'in'] },
...
export const COMMON_UNITS = [
  '°C', '°F', '%', '% RH', 'hPa', 'lux', 'ppm', 'mg/m³',
  'V', 'mV', 'A', 'mA', 'W', 'kW', 'm/s', 'L/min',
  'Pa', 'K', 'ppb', 'µg/m³', 'cm', 'm', 'kg', 'g',
] as const
