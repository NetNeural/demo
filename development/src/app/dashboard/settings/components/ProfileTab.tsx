...
export function ProfileTab() {
  ...
  const [phoneSecondarySmsEnabled, setPhoneSecondarySmsEnabled] = useState(false);
  ...
  useEffect(() => {
    const loadProfile = async () => {
      ...
      const { data: userRecord } = await supabase
        .from('users')
        .select('full_name, phone_number, phone_number_secondary, phone_sms_enabled, phone_secondary_sms_enabled')
        .eq('id', user.id)
        .single();
      ...
      if (userRecord) {
        ...
        if (userRecord.phone_number_secondary) setPhoneNumberSecondary(userRecord.phone_number_secondary);
        setPhoneSmsEnabled(userRecord.phone_sms_enabled || false);
        setPhoneSecondarySmsEnabled(userRecord.phone_secondary_sms_enabled || false);
      }
  ...
  const profileData = useMemo(
    ...
    [profileName, jobTitle, department, phoneNumber, phoneNumberSecondary, phoneSmsEnabled, phoneSecondarySmsEnabled]
  );
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center space-x-2 pl-1">
              <Checkbox
                ...
                onCheckedChange={(checked) => setPhoneSmsEnabled(checked as boolean)}
            ...
            {phoneNumberSecondary && (
              <div className="flex items-center space-x-2 pl-1">
                <Checkbox
                  ...
                  onCheckedChange={(checked) => setPhoneSecondarySmsEnabled(checked as boolean)}
                />
                <label
