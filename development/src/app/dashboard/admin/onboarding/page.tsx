...
const ONBOARDING_STEPS = [
  ...
  {
    id: 'org',
    label: 'Organization Set Up',
    icon: <Building2 className="h-4 w-4" />,
  },
  {
    id: 'device',
    label: 'First Device Added',
    icon: <Wifi className="h-4 w-4" />,
  },
  {
    id: 'alert',
    label: 'First Alert Created',
      ...
      if (memberships) {
        ...
        setStats({
          ...
          complete: mapped.filter(
            (u) => u.completed_steps === ONBOARDING_STEPS.length
          ).length,
        })
      }
    } catch (e) {
    ...
    <div className="flex-1 space-y-6 p-4 pt-6 md:p-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Last 50 organization members, ordered by join date
          </CardDescription>
        </CardHeader>
        <CardContent>
          {isLoading ? (
            ...
            <div className="space-y-2">
              {users.map((u) => {
                const pct = Math.round(
                  (u.completed_steps / u.total_steps) * 100
                )
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {isStuck && (
                          <Badge className="border border-yellow-200 bg-yellow-100 text-xs text-yellow-700">
                            needs help
                          </Badge>
                        )}
                      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Manual verification items for the initial user experience
          </CardDescription>
        </CardHeader>
        <CardContent>
