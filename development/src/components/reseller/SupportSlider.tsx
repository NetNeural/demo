...
const SUPPORT_OPTIONS: SupportOption[] = [
  ...
  },
  {
    ...
    description:
      'NetNeural handles all support; fee deducted from your margin.',
    fee_pct: 0.1,
            ...
            <button
              ...
              className={cn(
                ...
                selected === option.value
                  ? `${option.color} ring-current/30 ring-1 ring-inset`
                ...
                <div className="mt-3 grid grid-cols-2 gap-3 rounded-md bg-black/20 p-3 text-xs">
                  ...
                  <div>
                    ...
                    <p
                      className={cn(
                        'font-bold',
                        netMargin >= 0.1 ? 'text-emerald-400' : 'text-amber-400'
                      )}
                    >
        ...
        <DialogContent className="border-white/[0.08] bg-gray-900 text-white sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-gray-400">
              Changing from{' '}
              <strong className="text-gray-200">{currentOption.label}</strong>{' '}
              to{' '}
          ...
          <div className="rounded-lg bg-white/[0.04] p-4 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-semibold">
                {pendingOption.fee_pct === 0
                  ? 'None'
                  : `${(pendingOption.fee_pct * 100).toFixed(0)}%`}
              </span>
            </div>
