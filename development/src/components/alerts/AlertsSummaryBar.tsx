...
export function AlertsSummaryBar({ alerts, onFilterBySeverity }: AlertsSummaryBarProps) {
  const stats = {
        ...
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <Badge 
                variant="outline" 
                className="border-orange-500 text-orange-700 dark:text-orange-400 cursor-pointer hover:opacity-80"
              ...
              <Badge 
                variant="outline" 
                className="border-yellow-500 text-yellow-700 dark:text-yellow-400 cursor-pointer hover:opacity-80"
              ...
              <Badge 
                variant="outline" 
                className="border-blue-500 text-blue-700 dark:text-blue-400 cursor-pointer hover:opacity-80"
          ...
          <div className="flex items-center space-x-4">
            <div className="text-sm">
              ...
              <span className="text-muted-foreground ml-1">Unacknowledged</span>
            </div>
            <div className="text-sm">
