      ...
      {toasts.map((toast) => (
        <div
          ...
          className={cn(
            ...
            toast.variant === "default" && "border-gray-200 bg-white text-gray-900"
          )}
        >
          ...
          <button
            ...
            className="absolute right-2 top-2 rounded-md p-1.5 opacity-70 hover:opacity-100 transition-opacity hover:bg-black/10 focus:outline-none focus:ring-2 focus:ring-offset-2"
