  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'max-md:inset-0 max-md:h-full max-md:max-h-full max-md:w-full max-md:max-w-none max-md:translate-x-0 max-md:translate-y-0 max-md:rounded-none max-md:p-0',
        className
      )}
      {...props}
    >
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      ...
      'max-md:sticky max-md:top-0 max-md:z-40 max-md:border-b max-md:bg-background max-md:px-6 max-md:py-4 max-md:text-left',
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      ...
      'max-md:sticky max-md:bottom-0 max-md:flex-col max-md:gap-2 max-md:border-t max-md:bg-background max-md:px-6 max-md:py-4',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn('flex-1 overflow-y-auto py-4', 'max-md:px-6', className)}
    {...props}
  />
))
