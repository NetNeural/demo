  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "max-md:inset-0 max-md:max-w-none max-md:translate-x-0 max-md:translate-y-0 max-md:rounded-none max-md:w-full max-md:h-full max-md:max-h-full max-md:p-0",
        className
      )}
      {...props}
    >
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      ...
      "max-md:sticky max-md:top-0 max-md:bg-background max-md:z-40 max-md:px-6 max-md:py-4 max-md:border-b max-md:text-left",
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      ...
      "max-md:sticky max-md:bottom-0 max-md:bg-background max-md:px-6 max-md:py-4 max-md:border-t max-md:flex-col max-md:gap-2",
      className
    )}
    {...props}
  />
