...
const PHONE_SENSORS = [
  ...
  },
  {
    name: 'Humidity',
    icon: Droplets,
    description: 'Relative humidity (%) — available on select Android devices',
    telemetryKeys: 'relative_humidity',
    ios: false,
    android: true,
  },
  {
    name: 'Step Counter',
    icon: Footprints,
    description: 'Pedometer step count — walking/running detection',
    telemetryKeys: 'step_count',
    ios: true,
    android: true,
  },
  {
    name: 'Gravity',
    icon: ArrowDown,
    description: '3-axis gravity vector (m/s²) — device orientation',
    telemetryKeys: 'gravity_x, gravity_y, gravity_z',
    ios: true,
    android: true,
  },
  {
    ...
    icon: Move3d,
    description: '3-axis acceleration minus gravity (m/s²) — pure motion',
    telemetryKeys: 'linear_accel_x, linear_accel_y, linear_accel_z',
    ios: true,
    android: true,
  },
  {
    ...
    icon: RotateCw,
    description: 'Device orientation as rotation vector — 3D pose',
    telemetryKeys: 'rotation_x, rotation_y, rotation_z',
    ios: true,
    android: true,
  },
  {
    name: 'WiFi Signal',
    icon: Signal,
    description: 'WiFi RSSI (dBm) — signal strength for indoor positioning',
    telemetryKeys: 'wifi_rssi',
    ios: true,
    android: true,
  },
]
