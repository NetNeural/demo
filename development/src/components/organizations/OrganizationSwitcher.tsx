              ...
              <div className="flex items-center gap-2">
                ...
                <Badge
                  ...
                  className={cn(
                    ...
                    roleInfo.color === 'blue' && 'bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-300',
                    roleInfo.color === 'green' && 'bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-300',
                    roleInfo.color === 'gray' && 'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300'
                  )}
                >
                  {roleInfo.label}
                </Badge>
