...
export function AwsIotConfigDialog({
  ...
  const saveConfig = async () => {
    ...
    try {
      ...
      console.log('[AwsIotConfigDialog] Saving config:', {
        integrationId,
        organizationId,
      })
      ...
      if (integrationId) {
        console.log(
          '[AwsIotConfigDialog] Performing UPDATE with ID:',
          integrationId
        )
        ...
        console.log('[AwsIotConfigDialog] Update result:', {
        ...
        console.log('[AwsIotConfigDialog] Create result:', {
          success: response.success,
        })
      ...
      <Tabs defaultValue="general" className="w-full">
        ...
        <TabsContent value="general" className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              className={
                !config.secret_access_key.trim() ? 'border-red-300' : ''
              }
            />
          </div>
            ...
            >
              ...
              <SelectContent>
                <SelectItem value="import">
                  Import (AWS IoT → NetNeural)
                </SelectItem>
                <SelectItem value="export">
                  Export (NetNeural → AWS IoT)
                </SelectItem>
        ...
        <TabsContent value="conflicts" className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(
                value: 'manual' | 'local_wins' | 'remote_wins' | 'newest_wins'
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="remote_wins">
                  Remote Wins (AWS IoT takes priority)
                </SelectItem>
          ...
          <div className="space-y-2 rounded-lg bg-muted p-4">
            ...
            <ul className="list-inside list-disc space-y-1 text-sm text-muted-foreground">
              ...
              <li>
                <strong>Remote Wins:</strong> AWS IoT version always takes
                priority
              </li>
              <li>
        ...
        <TabsContent value="webhooks" className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            />
            <p className="text-sm text-muted-foreground">
              ✨ This URL is automatically generated. Configure it in your AWS
              IoT Rules.
            </p>
          </div>
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">
              Configure your AWS IoT Core integration settings
            </p>
          </div>
        </div>
