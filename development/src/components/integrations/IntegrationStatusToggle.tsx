...
export function IntegrationStatusToggle({
  ...
  return (
    <div className="flex items-center justify-between rounded-lg border-b border-t bg-muted p-4 pb-4 pt-4">
      ...
      <div className="flex items-center gap-3">
        <span
          className={`text-sm font-semibold ${status === 'active' ? 'text-green-600 dark:text-green-500' : 'text-gray-500 dark:text-gray-400'}`}
        >
