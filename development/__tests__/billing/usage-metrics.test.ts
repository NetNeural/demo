...
describe('Usage Metrics', () => {
  it('metric has organization_id and device count', () => {
    const metric = { organization_id: 'org-1', active_devices: 5, period_start: '2026-03-01', period_end: '2026-03-31' }
  ...
  it('period start is before period end', () => {
    ...
    expect(new Date(metric.period_end) > new Date(metric.period_start)).toBe(true)
  })
})
