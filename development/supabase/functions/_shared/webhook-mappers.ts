...
// ===========================================================================
export function mapGoliothWebhook(
  ...
  const telemetryTimestamp =
    (telemetry?.timestamp as string) || payload.timestamp
  ...
  const metadata: Record<string, unknown> = {
    ...(typeof baseMetadata === 'object' && baseMetadata !== null
      ? baseMetadata
      : {}),
  }
...
// ===========================================================================
export function mapAwsIotWebhook(
  payload: RawWebhookPayload
): NormalizedWebhookPayload {
  ...
  return {
    ...
    metadata:
      payload.attributes || device.attributes || device.metadata || device,
...
// ===========================================================================
export function mapAzureIotWebhook(
  payload: RawWebhookPayload
): NormalizedWebhookPayload {
...
// MQTT Webhook Mapper
// ===========================================================================
export function mapMqttWebhook(
  payload: RawWebhookPayload
): NormalizedWebhookPayload {
  const device = payload.device || payload.data || payload
...
// ===========================================================================
export function mapCustomWebhook(
  payload: RawWebhookPayload
): NormalizedWebhookPayload {
