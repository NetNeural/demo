...
Deno.test('Cache Key Generation - Device ID and Reading Count', () => {
  ...
  const telemetryReadings = [
    { telemetry: { value: 72 }, device_timestamp: '2026-02-17T10:00:00Z', received_at: '2026-02-17T10:00:01Z' },
    { telemetry: { value: 73 }, device_timestamp: '2026-02-17T10:05:00Z', received_at: '2026-02-17T10:05:01Z' },
  ]
...
Deno.test('Temperature Anomaly Detection - Rising Trend', () => {
  ...
  const trend = lastValue > firstValue ? 'rising' : lastValue < firstValue ? 'falling' : 'stable'
