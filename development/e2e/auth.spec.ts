...
async function performLogout(page: Page) {
  ...
  const userMenu = page.locator('[data-testid="user-menu"], button:has-text("Profile"), button:has-text("Menu")').first()
...
test.describe('Authentication Flows', () => {
  ...
  test.describe('Login Flow', () => {
    ...
    test('should successfully login with valid credentials', async ({ page }) => {
      ...
      await expect(page.locator('text=/dashboard|home|overview/i').first()).toBeVisible()
    })
  ...
  test.describe('Session Management', () => {
    ...
    test('should show user info in dashboard', async ({ page }) => {
      ...
      const userInfo = page.locator(`text=${TEST_USER.email}, text=${TEST_USER.name}`).first()
  ...
  test.describe('Remember Me Functionality', () => {
    ...
    test('should persist session when Remember Me is checked', async ({ page, context }) => {
      ...
      // Check Remember Me
      const rememberMeCheckbox = page.locator('label:has-text("Remember Me")').locator('input[type="checkbox"]').first()
  ...
  test.describe('Multi-tenant Isolation', () => {
    ...
    test('should show only user-specific data', async ({ page }) => {
      ...
      const devicesSection = page.locator('[data-testid="devices-list"], text=Devices').first()
